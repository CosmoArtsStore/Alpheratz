...
export const useScroll = ({ photosLength, columnCount, gridHeight, ROW_HEIGHT, disableProgrammaticBounds = false }: UseScrollArgs) => {
    ...
    }, [columnCount, disableProgrammaticBounds, gridHeight, maxScrollTop, photosLength]);
