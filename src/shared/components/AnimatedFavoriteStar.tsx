...
import styles from './AnimatedFavoriteStar.module.css';
...
export const AnimatedFavoriteStar = ({
  ...
  const rootClassName = [
    styles.root,
    liked ? styles.liked : '',
    animationPhase === 'fade-in' ? styles['fade-in'] : '',
    animationPhase === 'fade-out' ? styles['fade-out'] : '',
    interactive ? '' : styles['display-only'],
    className === 'favorite-star-modal' ? styles.modal : '',
    className === 'favorite-star-corner' ? styles.corner : '',
    className === 'favorite-star-gallery' ? styles.gallery : '',
  ]
    .filter(Boolean)
    .join(' ');
