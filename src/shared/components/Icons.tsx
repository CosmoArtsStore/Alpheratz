...
export const Icons = {
  ...
  Sun: () => (
    <svg viewBox="0 0 24 24" className={styles['icon-svg']}>
      <path d="M12 7A5 5 0 1 1 7 12A5 5 0 0 1 12 7M12 2L13.09 5.26L16 4L14.74 6.91L18 8L14.74 9.09L16 12L13.09 10.74L12 14L10.91 10.74L8 12L9.26 9.09L6 8L9.26 6.91L8 4L10.91 5.26L12 2Z" />
    </svg>
  ),
  Moon: () => (
